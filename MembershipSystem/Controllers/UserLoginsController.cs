...
namespace MembershipSystem.Controllers
{
    public class UserLoginsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "UserId,LoginProvider,ProviderKey")] UserLogin userLogin)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "UserId,LoginProvider,ProviderKey")] UserLogin userLogin)
        {
            if (ModelState.IsValid)
            {
